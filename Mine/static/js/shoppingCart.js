$(function(){
	...
	if(arr.length <= 0){
		...
		for(var i = 0; i < arr.length; i++){
			var ul = $("<ul><li class='cart_message1_content_li1'><img src=" + arr[i].img + "/><a href='goods.html' class='names'>"+arr[i].name+"<em>[特价]</em></a></li><li class='cart_message1_content_li2'>"+arr[i].price+"</li><li class='cart_message1_content_li3'><input type='text' value="+arr[i].num+"></li><i class='minus'>-</i><i class='add'>+</i><li class='cart_message1_content_li4'>￥"+arr[i].price.split('￥')[1] * arr[i].num+"</li><li class='cart_message1_content_li5'><a href=''>加入收藏夹</a><br/><a href='' name="+arr[i].name+">删除</a></li></ul>");
			 num += arr[i].num * 1;
